...
# Load current table
df = pd.read_csv("/work/samodha/sachin/MWAS/MetabolicGraphNetwork/full_network/Full_data.txt", header=None, names=["KO"])
df["EC"] = ""  # Initialize EC column
df["RXN"] = ""  # Initialize RXN column
...
df["EC"] = new_ec
df["RXN"] = new_rxn
df.to_csv("/work/samodha/sachin/MWAS/MetabolicGraphNetwork/full_network/Full_data_EX_RXN.csv", index=False)
